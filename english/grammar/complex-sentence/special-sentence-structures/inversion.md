...
- There be 句型扩展结果: **There be + n. + 介词短语**
    - ...<ins>there was</ins> significant flu activity in *almost(adv. 几乎)* every state...
...
only 位于句首（only后可以是词、词组、句子），句子要部分倒装，翻译为: **直到...才**

- <ins>Only recently(直到最近)</ins> **have they come** to see the vital part <ins>forests will have to play in *storing carbon(碳存储)*</ins>.
    ...
    - come to do 渐渐开始/意识到
        - come to see 逐渐意识到；开始明白
- <ins>Only then(直到那时)</ins> **will they be** useful servants and not Frankenstein's out-of-control monster.
    - 正常语序: they will be useful servants...only then
    - only then 提前
    - 将 they will be useful servants 变为一般疑问句 == will they be useful servants...
- <ins>Only recently</ins> **did linguists begin** the serious study of languages <ins>that were very different from their own</ins>.

#### 虚拟条件句省略 if

虚拟条件句省略if，从句要部分倒装（如果一个从句中只有一个动词be，则直接把它提前，即放到主语前），主句不变

- But **had Entergy kept** its word, that debate would be *beside the point(无关紧要的)*.
