  ...
  ui.card.innerHTML = `
    <div class="completion-container" style="height: 100%; overflow-y: auto; padding: 1.5rem;">
      <div class="completion-header" style="text-align: center; padding-bottom: 1rem;">
        ...
        <h2 class="completion-title" style="font-size: 1.5rem; color: var(--primary); margin-bottom: 0.5rem;">Completed!</h2>
        <p style="font-size: 1rem; color: var(--text-sub); margin-bottom: 1.5rem;">Great job finishing this unit.</p>
      </div>
      <div style="background: var(--card-bg); padding: 1rem; border-radius: 12px; margin-bottom: 1rem;">
        <div class="completion-stats-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.75rem;">
          <div style="text-align: center;"><div class="completion-stats-value" style="font-size: 1.5rem; font-weight: 700; color: var(--primary);">${stats.totalCards}</div><div class="completion-stats-label" style="font-size: 0.75rem; color: var(--text-sub);">Total Cards</div></div>
          <div style="text-align: center;"><div class="completion-stats-value" style="font-size: 1.5rem; font-weight: 700; color: var(--danger);">${stats.totalErrors}</div><div class="completion-stats-label" style="font-size: 0.75rem; color: var(--text-sub);">Errors</div></div>
          <div style="text-align: center;"><div class="completion-stats-value" style="font-size: 1.5rem; font-weight: 700; color: var(--success);">${stats.accuracy}%</div><div class="completion-stats-label" style="font-size: 0.75rem; color: var(--text-sub);">Accuracy</div></div>
        </div>
      </div>
      <div style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); padding: 1rem 1.25rem; border-radius: 12px; margin-bottom: 1rem; border: 1px solid #bbf7d0;">
        <div class="completion-progress-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
          <div style="text-align: left;"><div style="font-size: 0.75rem; color: #166534; margin-bottom: 0.25rem; font-weight: 600;">✅ Mastered</div><div class="completion-progress-value" style="font-size: 1.25rem; font-weight: 700; color: #16a34a;">${stats.cardsMastered}</div></div>
          <div style="text-align: left;"><div style="font-size: 0.75rem; color: #991b1b; margin-bottom: 0.25rem; font-weight: 600;">🔄 Review Needed</div><div class="completion-progress-value" style="font-size: 1.25rem; font-weight: 700; color: #dc2626;">${stats.cardsNeedingReview}</div></div>
        </div>
      </div>
      <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); padding: 1rem 1.25rem; border-radius: 12px; margin-bottom: 1rem; border: 1px solid #fcd34d;">
        <div class="completion-time-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
          <div style="text-align: left;"><div style="font-size: 0.75rem; color: #92400e; margin-bottom: 0.25rem; font-weight: 600;">⏱️ Study Duration</div><div class="completion-time-value" style="font-size: 1.25rem; font-weight: 700; color: #d97706;">${stateManager.formatDuration(stats.duration)}</div></div>
          <div style="text-align: left;"><div style="font-size: 0.75rem; color: #92400e; margin-bottom: 0.25rem; font-weight: 600;">📊 Avg per Card</div><div class="completion-time-value" style="font-size: 1.25rem; font-weight: 700; color: #d97706;">${stateManager.formatDuration(stats.avgTimePerCard)}</div></div>
        </div>
