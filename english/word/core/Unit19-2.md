...
- Among the most popular: paternity and **kinship** testing, which adopted children can use to find their biological
  relatives and families can use to <ins>track down(追查到)</ins> kids <ins>put up for adoption(送去领养)</ins>.
...
- adj. 当代的
- in contemporary China 在当代中国
- temporary adj. 临时的
- temporarily [tempəˈrerɪlɪ] adv. 暂时
- modernise vt. 使现代化
