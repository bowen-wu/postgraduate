...
- stabilize [ˈsteɪbəlaɪz] v. 使稳定；使稳固
- steady
    - adj. 稳定的
    - == stable
...
- 词组
    - follow suit 跟着做
    - suit one's own purpose 满足自己的目的
- suitable adj. 合适的
...
- lenient [ˈliːniənt]
    - adj. （惩罚或执法时）宽大的
    - Opposite: strict adj. 严格的
    - If you're not overly strict, and you show *tolerance([ˈtɑːlərəns] n. 宽容)* and
      *mercy([ˈmɜːrsi] n. 宽容; 怜悯; 幸运; 侥幸)* when someone dose something wrong, you're being **lenient**.
    - == merciful [ˈmɜːrsɪfl] adj. 仁慈的，宽恕的，温和的，（情形）良好的，顺利的，（处罚）宽大的
...
- paradise [ˈpærədaɪs]
    - n. 天堂
    - == heaven [ˈhevn] n. 天堂；(pl.)天空；乐事
- paradox [ˈpærədɑːks]
    - n. 悖论；矛盾的人(或事物、情况)
    - It's a work of **paradox** and *ambiguity([ˌæmbɪˈɡjuːəti] n. 模棱两可)*.
    - paradoxical [ˌpærəˈdɑːksɪkl] adj. 自相矛盾的
- paralyse [ˈpærəlaɪz]
    - vt. 使不能正常工作
...
- [ˈpæʃn]
- n. 激情
- **Passion** first and everything else will <ins>fall into place(顺利安排、各就各位、自然形成)</ins>.
- passionate [ˈpæʃənət]
    - adj. 狂热的
    - ...**passionate** consumers will voice their opinions in quicker, more visible, and much more damaging ways.
- enthusiasm
    - n. 热情；热衷的事物
    - You might show **enthusiasm** if you find out that all the shoes are on sale for 70 percent off today. The word
      **enthusiasm** indicates **intense excitement**.
...
- versus [ˈvɜːrsəs]
    - prep. (vs.)对抗；（比较两种不同想法、选择等）与...相对
    - The concept of <ins>man **versus** machine</ins> is at least as old as the industrial revolution...
...
- fraud [frɔːd]
    - n. 欺诈罪
    - A **fraud** is a something that **deceives or tricks** another person, usually to get their money, **Frauds** are
      **dishonest**.
- disguise [dɪsˈɡaɪz]
    - vt. 伪装
    - ...dreams were the <ins>**disguised** shadows of(...的伪装影子)</ins> our unconscious desires and fears.
