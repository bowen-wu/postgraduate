...
- embarrassment n. 尴尬
- awkward [ˈɔːkwərd]
    - adj. （使用）不便的；（工作）棘手的；令人尴尬的
    - If you feel **awkward** being *humorous([ˈhjuːmərəs] adj. 滑稽的)*, you must practice so that it becomes more
      natural.
...
- adj. 相互的；共同的
- mutual trust 互信
- unilateral [ˌjuːnɪˈlætərəl] adj. 单方的，单边的
...
- v. 逮捕
- n. 逮捕
- The court has ruled that police don't violate the Fourth Amendment when they go through the wallet or pocketbook of an
  **arrested** person without warrant.
...
- n. 传记
- autobiography n. 自传
- biographical [ˌbaɪəˈɡræfɪkəl] adj. 传记的
...
- vt. 建造
- n. 构思
- He *eventually([ɪˈventʃuəli] adv. 最后地)* **constructed** a huge business *empire([ˈempaɪər] n. 帝国)*.
- construction n. 建造；建筑物；建筑业；创立
- instruct
    - vt. 指示；指导
