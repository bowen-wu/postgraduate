...
- That suggests it is in the broader corporate **interest** to *recruit([rɪˈkruːt] vt. 招募)* top candidates for
  increasingly tough jobs.
    ...
    - in the interest of sth./sb. 为了...的利益/符合...的利益/从...的利益出发
...
- If you climb the corporate **ladder**, you're moving up in the business world.
    - climb the corporate ladder 在公司/职场中往上爬；升职；事业晋升
...
- There is traditional **live** music played most nights.
    - most nights 大多数晚上
- Devoted *concertgoers(['kɑnsərtɡoʊr] n. 常参加音乐会者)* who reply that recordings are no substitute for **live**
  performance are missing the point.
    - no substitute for 不可替代/无法代替
    - miss the point 没抓住重点/没理解真正的问题
    - devoted adj. 忠实的；投入的；狂热的
...
- **Might** is physical strength or power.
    - strength [streŋθ] n. 力量；实力；优势，优点，长处
- We fear the military **might** of the enemy.
    - military [ˈmɪləteri] adj. 军事的
    - enemy [ˈenəmi] n. 敌人；敌国
- mighty
    - adj. 强有力的，有势力的
    - mightily
        - adv. 非常，很大程度上；猛烈地
...
- v. 仿效，以...为榜样
- n. 模型；模特；典范，模范
- If you are a **model** student, you do everything as the school and teachers wish: you are the standard.
- If you **model** your life on your hero's, you try to do what he or she does.
    - model A on/upon B 以 B 为榜样/参照来塑造 A
- This impact will not only be through the publication in Science itself, but hopefully through a large group of
  publishing places that may want to **model** their approach after Science.
  这种影响不仅会通过《Science》期刊自身的发表来实现，而且还希望能通过一大批其他出版机构——它们可能会希望效仿《Science》的做法
    - model A after B 以 B 为榜样/仿效 B 来设计或采取 A

## shoulder

- v. 承担；承当
- n. 肩膀
- They fell into step, walking **shoulder** to shoulder with their heads bent against the rain. 他们步调一致地走着，肩并肩，低着头迎着雨
    - fall into step （走路时）步伐变得一致；行动、节奏、想法开始协调一致
...
- ...**it was** the Federal Circuit itself **that** introduced such patents with its 1998 decision in the so-called
  ...
  正是联邦巡回上诉法院本身，在所谓的 State Street Bank 案中，通过其 1998 年的裁决引入了这种专利，批准了一项关于共同基金资产集中运作方式的专利
    - introduce v. 介绍；引进
    - a way of 一种...的方式/方法
    - pooling mutual-fund assets 集中/合并共同基金资产
...
- In recent weeks the No.2 executives at Avon and American Express quit with the explanation that they were looking
  for a CEO **post**. 近几周，雅芳和美国运通的二号高管相继辞职，给出的解释是他们在寻找一个 CEO 职位
    - with the explanation that... 给出的解释是.../理由是...

## partial

- [ˈpɑːrʃl]
- adj. 局部的；片面的，偏爱的
- There is no such thing as failure, only **partial** success! 世上并不存在失败，只有不完全的成功
    - There is no such thing as... 根本不存在所谓的.../...这种东西根本没有
- I might be accused of being **partial**.
    - accuse [əˈkjuːz] vt. 指责；指控
- partially [ˈpɑːrʃəli]
    - adv. 部分地，在一定程度上；不完全地；偏爱地
