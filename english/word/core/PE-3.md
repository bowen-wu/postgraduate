...
- But the idea...**rests** on an understanding of the established conventions and special responsibilities of the news
  media. 但这一观点建立在对新闻媒体既定惯例和特殊责任的理解之上
    - understanding of + noun 对...的理解
...
- The value of knowledge and the **return** on the public investment in research depends, in part, upon
  <ins>wide distribution(广泛的分布)</ins> and ready access. 知识的价值，以及公共科研投资所获得的回报，在一定程度上取决于知识是否被广泛传播，以及人们是否能方便地获取它
    - in part 部分地/在一定程度上
...
- The conflict has been surfacing since 2002, when the corporation bought Vermont's only nuclear power **plant**, an
  aging reactor in Vernon.
    - aging [ˈedʒɪŋ] n. 老化; 老龄化; （酒等的）陈化; 熟化
...
- v. 塑造，影响
- n. 形状，样子
- You can **shape** something by giving it form, or **influence** someone, as in a teacher who **shapes** young minds.
    - form
        - v. 组成；产生
        - n. 形式；种类；外形
...
- For example, he theorised that a judge fearful of appearing too soft on crime might be more likely to send someone to
  prison/if he had already **sentenced** five or six other defendants only to forced community service on
  that day. 例如，他从理论上推测，如果一位担心对犯罪行为表现得太过仁慈的法官在一天当中已经对五六名被告只判处了强制性社区服务，那么他更有可能会将接下来的被告送进监狱。
    - fearful adj. 担心的
    - fearful of + noun/doing 害怕...
...
- v. 保护，庇护
- n. 盾牌
- I **shielded** my eyes against the *glare([ɡler] n. 强光)*.
    - shield A against/from B 保护 A 免受 B 的伤害
- **Shielded** by third-party payers from the cost of our care, we demand everything that can possibly be done for us,
  even if it's useless. 由于有第三方付款方替我们承担医疗费用，我们不用直接面对医疗成本，因此我们会要求所有可能为我们做的治疗，即使这些治疗是没有用的
    - demand [dɪˈmænd]
        - vt. 强烈要求；需要
        - n. （顾客的）需求；（坚决的）要求；需求量
    - our care 我们的医疗服务
...
- sitting
    ...
    - I can't think of a single search I've done where a board has not instructed me to look at **sitting** CEOs first.
      我想不出有哪一次我参与的招聘中，董事会没有要求我优先考虑现任 CEO
        - search n. 招聘
        - conduct a search 进行招聘选拔
...
- v. 浮出水面，显现
- n. 表面
- an uneven road surface 不平整的路面
- The argument first **surface** two years ago.
- The conflict has been **surfacing** since 2002, when the corporation bought Vermont's only nuclear power plant, an
  aging reactor in Cernon.
...
- n. 交通；通信量，流量；非法买卖
- traffic jam 交通堵塞
- *celebrity([səˈlebrəti] n. 名人)* with large **traffic** amount
    - == celebrity with huge followings
    - == celebrity with devoted fan bases 拥有忠实粉丝群体的名人
- to **traffic** in stolen cultural relics 非法贩卖被盗文物
    - traffic in something 非法买卖/贩卖
    - relic [ˈrelɪk] n. 遗物
- We define such media as owned media whose **traffic** is so strong that other organizations place their content or
  e-commerce engines within that environment. 我们将这类媒体定义为自有媒体，其流量之大，以至于其他组织会将其内容或电商系统嵌入该平台环境中

## underline

- v. 强调，突出；划下划线
- n. 下划线
- The report **underlines** the importance of education.
...
- v. 表达，发声
- n. 声音，嗓音；发言权
- to speak in a deep/soft voice 用低沉/轻柔的声音说话
- to raise/lower your voice
- He was so excited at the concert last night that he lost his **voice**.
