...
- eligible
    - adj. 合格的；符合条件的
    - == qualified
    - Only If the jobless arrive at the job centre with a CV, register for online job search, and start looking for work
      will they be **eligible** for <ins>benefit(补助金；津贴)</ins>.
...
- exert
    - vt. 施加（影响、压力）
    - These designers came to <ins>**exert** *enormous/profound* influence on(产生深远影响)</ins> the
      *course/development* of American architecture, but none more so than Mies.
- utilize vt. 利用
