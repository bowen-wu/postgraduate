...
- reflective
    - adj. 反思的
    - **Reflective** is an adjective that can describe a **person** who **thinks things through**, or a **surface** that
      **reflects light or sound**.
...
- dilemma [dɪˈlemə]
    - n. （进退两难的）困境
    - Nowadays many university graduates are facing the **dilemma** about whether they should apply for a job or
...
- participation [pɑːrˌtɪsɪˈpeɪʃn] n. 参与
- attend
    - v. 出席；上（学）
    - attendance
        - n. 出席
