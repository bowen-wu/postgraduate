...
% =========================
    ...
    \begin{enumerate}
        \item $\lim\limits_{n\to\infty} a_n = A \; {\color{green}{\Rightarrow}} \lim\limits_{n\to\infty} |a_n| = |A|$
        \item $\lim\limits_{x\to x_0} f(x) = A \; {\color{green}{\Rightarrow}} \lim\limits_{x\to x_0} |f(x)| = |A|$
