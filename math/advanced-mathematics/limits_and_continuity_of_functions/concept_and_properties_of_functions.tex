...
% =========================
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item $\int_{-a}^{a} f(x)\,dx = \begin{cases} 0, & f(x) \text{ 为奇函数} \\ 2\int_0^a f(x)\,dx, & f(x) \text{ 为偶函数} \end{cases}$
        \end{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item 狄利克雷函数 $D(x) = \begin{cases} 1, & x \in \mathbb{Q} \\ 0, & x \notin \mathbb{Q} \end{cases}$：任意非零有理数都是其周期（无最小正周期）
        \end{itemize}
    \end{enumerate}
