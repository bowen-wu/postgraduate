...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \[
            {\color{red}{r = \sqrt{x^2 + y^2}}}, \quad \theta = \arctan\frac{y}{x}
        \]
    ...
    \begin{enumerate}
        \item 换被积函数：$f(x, y) \Rightarrow f[x(u, v), y(u, v)]$
        \item 换积分区域：$\diint_{D_{xy}} \Rightarrow \diint_{D_{uv}}$
        \item 换积分变量：$\mathrm{d}x\mathrm{d}y = |J|\mathrm{d}u\mathrm{d}v$
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{circlenum}
            ...
            转化为极坐标，区域为第一象限：$0 \leq \theta \leq \dfrac{\pi}{2}$，$0 \leq r < +\infty$，则
            \[
    ...
    \begin{enumerate}
        ...
        \item 积分与字母用谁无关
        \begin{itemize}
            \item $\diint_{D_{xy}} f(x, y)\,\mathrm{d}x\mathrm{d}y = \diint_{D_{yx}} f(y, x)\,\mathrm{d}y\mathrm{d}x$
        \end{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{analysisbox}
            ...
            \[
                ...
                =1.
            \]
            由区域条件 $x\ge0,\ y\ge0,\ x+y\le1$ 可得$0\le v\le1,\quad v\le u\le1$，因而
            \[
                \begin{aligned}
                    ...
                    &= \int_0^1 \left. ue^{\frac{v}{u}} \right|_{v=0}^{v=u} \mathrm{d}u
