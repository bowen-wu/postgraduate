...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item $\dint \dfrac{1}{x^2 - a^2}\,\mathrm{d}x = \dint \dfrac{1}{2a}(\dfrac{1}{a + x} - \dfrac{1}{a - x})\,\mathrm{d}x = \dfrac{1}{2a}(\ln|a + x| - \ln|a - x|) + C = \dfrac{1}{2a}\ln \left|\dfrac{x-a}{x+a}\right| + C$
            \item $\dint \dfrac{1}{a^2 - x^2}\,\mathrm{d}x = \dint -\dfrac{1}{2a}(\dfrac{1}{a + x} - \dfrac{1}{a - x})\,\mathrm{d}x = \dfrac{1}{2a}\ln \left|\dfrac{x+a}{x-a}\right| + C$
        \end{itemize}
        \item 三角函数降幂公式型
        \begin{itemize}
