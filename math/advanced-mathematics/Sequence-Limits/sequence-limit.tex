    ...
    \begin{enumerate}
        ...
        \begin{analysisbox}[示例]
            \begin{gather*}
                ...
                \Rightarrow \forall \epsilon > 0,\ \exists N > 0,\ n > N:\ |a_n - a| < \epsilon \\
                \Rightarrow ||a_n| - |a|| \leq |a_n - a| < \epsilon \quad (\text{由绝对值不等式}) \\
                \Rightarrow \lim_{n \to \infty} |a_n| = |a|
                \Rightarrow |a| - \epsilon < |a_n| < |a| + \epsilon
            \end{gather*}
        \end{analysisbox}
    \end{enumerate}
