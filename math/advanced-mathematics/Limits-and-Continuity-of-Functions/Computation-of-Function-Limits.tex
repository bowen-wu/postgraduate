...
% =========================
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \]
            时，函数 $f(x)$ 与 $F(x)$ 都趋于{\color{red}{零}}，即
            \[
    ...
    \begin{enumerate}
        \item $\displaystyle\frac{0}{0}, \frac{\infty}{\infty}, 0\times \infty, \infty - \infty, \infty^0, 0^0, 1^\infty$
        \item 解题思路
        \begin{itemize}
            \item 化简先行
            \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \textbf{抓大头法:} \\
            当 $x \to \infty$，则应抓分子和分母中关于 $x$ 的最高次项即可判断极限； \\
            当 $x \to 0$，则应抓分子和分母中关于 $x$ 的最低次项
        ...
        \begin{itemize}
            ...
            \item 如果函数中没有分母，则可以通过提取公因式或者做倒代换（创造分母再通分），出现分母后，再利用通分等恒等变形的方法，将加减法变形为乘除法
        \end{itemize}
        \item $\infty^0, 0^0$: $\lim u^v = e^{\lim v\lim u}$
    ...
    \begin{enumerate}
        ...
        \item 当 $x \to +\infty$ 时，有$\ln^{\alpha} x \ll x^{\beta} \ll a^{x}$，其中$\alpha,\beta>0,\ a>1$
        \item 当 $n \to \infty$ 时，有$\ln^{\alpha} n \ll n^{\beta} \ll a^{n} \ll n! \ll n^{n}$，其中$\alpha,\beta>0,\ a>1$
        \item 当 $\alpha > 0$ 时，
        \[
    ...
    \begin{enumerate}
        ...
        \[
            ...
            \lim_{x\to a} \frac{f'(x)}{F'(x)},
        \]
        \textbf{右极限存在，则左极限存在；但左极限存在，并不意味着右极限一定存在。} Case: $\lim\limits_{x\to 0} \displaystyle\frac{x^2 \sin \displaystyle\frac{1}{x}}{x}$
    \end{enumerate}
