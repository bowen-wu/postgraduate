...
% =========================
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item 倒代换：当被积函数分母的幂次比分子高两次及两次以上时，作倒代换，令$t = \displaystyle\frac{1}{t}$
    ...
    \begin{enumerate}
        ...
        \begin{circlenum}
            ...
            \begin{analysisbox}[Example]
                \[
                    \int \frac{2}{(2x-1)^2}\,\mathrm{d}x = \int \frac{2}{(2x-1)^2}\,\mathrm{d}(2x-1) = -\frac{1}{2x-1} + C
                \]
            \end{analysisbox}
            \item $Q_m(x)$的二次单因式$px^2 + qx + r$产生一项$\displaystyle\frac{Ax + B}{px^2 + qx + r}$。须$\Delta = q^2 - 4pr < 0$
            \begin{analysisbox}[Example]
                \[
                    \int \frac{x-1}{x^2 + 1}\,\mathrm{d}x = \int \frac{1}{x}\frac{2x}{x^2 + 1}\,\mathrm{d}x - \int \frac{1}{x^2 + 1}\,\mathrm{d}x = \frac{1}{x}\ln (x^2 + 1) - \arctan x + C
                \]
            \end{analysisbox}
