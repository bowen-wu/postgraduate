...
% =========================
    ...
    \begin{enumerate}
        ...
        \item $f(x)$ 是可积且以 $T$ 为周期的周期函数，则 $\int_{0}^{x} f(t)\,\mathrm{d}t$ 是以 $T$ 为周期的周期函数 $\Leftrightarrow \int_{0}^{T} f(x)\,\mathrm{d}x = 0 \Leftrightarrow \int_{a}^{x} f(t)\,\mathrm{d}t = \int_{a}^{0} f(t)\,\mathrm{d}t + \int_{0}^{x} f(t)\,\mathrm{d}t$ 亦是以 $T$ 为周期的周期函数 $(a \neq 0)$
