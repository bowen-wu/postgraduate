...
\begin{document}
    ...
    \begin{analysisbox}
            ...
            \[
                ...
                =\lim_{x\to\infty}\frac{(2x-1)e^{1/x}}{x}
                =\lim_{x\to\infty}\left(2-\frac{1}{x}\right)e^{1/x}=2.
            \]
            再求
            \[
                b=\lim_{x\to\infty}(y-kx)
                =\lim_{x\to\infty}\left[(2x-1)e^{1/x}-2x\right].
            \]
            利用展开式$e^{1/x}=1+\dfrac{1}{x}+o\!\left(\dfrac{1}{x}\right)$，有
            \[
                (2x-1)e^{1/x}
    ...
    \begin{analysisbox}
            ...
            \]
            \[
                y'=\frac{2x-2y}{6y^2-4y+2x}
                =\frac{x-y}{3y^2-2y+x}.
            \]

            驻点满足$y'=0$，故$x=y$。代回原方程：
            \[
            ...
            计算
            \[
                F_{xx}=-2,\quad F_y=6y^2-4y+2x,\quad F_y(1,1)=4,
            \]
            \[
                y''(1)= -\frac{-2}{4}=\frac{1}{2}>0.
            \]
            因此$(1,1)$为极小值点。
