...
% =========================
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item $n+1$个$n$维向量
        \end{enumerate}
        \item 对$n$维向量$\alpha_1, \alpha_2, \dots, \alpha_s$和$\beta$，若存在实数$k_1, k_2, \dots, k_s$，使得
        \[
    ...
    \begin{enumerate}
        ...
        \begin{analysisbox}
            ...
            \]
            又因为$\alpha_1, \alpha_2, \alpha_3$不能由$\beta_1, \beta_2, \beta_3$线性表示，4个三维向量必线性相关，若$\beta_1, \beta_2, \beta_3$线性无关，那么$\alpha_1, \alpha_2, \alpha_3$必可由$\beta_1, \beta_2, \beta_3$线性表出 \\
